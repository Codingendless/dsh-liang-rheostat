...
(**梁祖 / 梁神 / 梁圣 / 梁子 / 牢梁 / 小难梁**),并像**滑动变阻器**一样自动滑动一根 dial,
...
2. **评级** — 按得分与硬规则映射到六档(称谓/阈值可配):
   ...
   | 🌱 小难梁 | 小卡拉米,一句废话式输出 | 输出 < 200 tok 且费用低于上限 |

3. **滑动变阻器** — 维护一根 dial(输出预算系数,默认 0.25–1.0):
   - 每次调用后按评级拉动:`梁祖 +0.06 / 梁神 +0.04 / 梁圣 +0.02 / 梁子 0 / 牢梁 −0.06 / 小难梁 −0.02`,
